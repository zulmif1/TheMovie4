package id.ac.iainpekalongan.themovie4.widget;
...
public class StackWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "id.ac.iainpekalongan.themovie4.TOAST_ACTION";
    public static final String EXTRA_ITEM = "id.ac.iainpekalongan.themovie4.EXTRA_ITEM";
